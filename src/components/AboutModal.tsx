        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-white/10 bg-zinc-900/50 backdrop-blur-md z-10">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold font-display text-white">About Listening Project</h2>
            </div>
            <button
              onClick={onClose}
            ...
            <div className="max-w-3xl mx-auto space-y-12">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Listening Project is a neural audio interface designed to decode the world around you. We bypass traditional, high-latency speech-to-text pipelines by leveraging the Gemini Multimodal Live API, delivering fluid, context-aware translation that understands nuance, tone, and speaker identity in real-time.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-400 mb-6">
                  We built Listening Project as a high-performance Progressive Web App (PWA) to bridge the gap between cloud intelligence and edge security.
                </p>
